            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 my-16 items-center">
              <div className="lg:col-span-7 mb-16">
                <h1 className="mb-5 lg:text-start text-center sm:leading-snug leading-tight ">
                 <span className="text-3xl text-red-600"> La régie</span><br /><span className="">N</span>EOREGIE
                </h1>
                <p className="text-white font-normal mb-10 max-w-[70%] lg:text-start text-center lg:mx-0 mx-auto ">
                  Apport de solutions médias pour accompagner les agences et 
                  les annonceurs pour répondre à leurs objectifs de communication avec 
                  des dispositifs adaptés et ciblés.
                </p>
                <div className="flex align-middle justify-center lg:justify-start">
                  <button className="text-xl font-semibold text-white py-4 px-6 lg:px-12 bg-gradient-to-r from-red-600 to-secondary hover:from-secondary hover:to-red-600 rounded-xl mr-6 cursor-pointer">
                    Découvrir
                  </button>
                  <button
                    onClick={openModal}
                  ...
                  >
                    <Image
                      ...
                      height={47}
                    />
                    <span className="hover:text-red-600">Le Concept</span>
                  </button>
                </div>
              </div>
